...
import id.gamedest.githubusersubmission2.helper.StackWidgetService
import id.gamedest.githubusersubmission2.user.DetailUser.Companion.EXTRA_AVATAR
import id.gamedest.githubusersubmission2.user.DetailUser.Companion.EXTRA_USERNAME
...
class FavoritesStackWidget : AppWidgetProvider() {
            ...
            if (intent.action == INTENT_ACTION) {
                ...
                val detailUserFavoriteFragment = context?.let {
                    NavDeepLinkBuilder(it)
                        ...
                        .setDestination(R.id.detailUser)
    ...
    companion object {
        private const val INTENT_ACTION = "id.gamedest.githubusersubmission2.INTENT_ACTION"
        ...
        const val EXTRA_ITEM = "id.gamedest.githubusersubmission2.EXTRA_ITEM"
